    ...
    >
      ...
      <div class="mb-6 pb-4 border-b border-blue-300 p-4">
        ...
        <div class="grid grid-cols-7 gap-2 text-center text-sm">
          ...
          >
            ...
            <div
              class="w-8 h-8 flex items-center justify-center" :class="[
      ...
      <div class="mb-6 mt-auto pb-4 border-b border-blue-300 p-4">
        ...
        <div class="text-center">
          ...
          <div>
            <i
              class="pi pi-desktop text-5xl sm:text-7xl block gradient-icon pb-2"
              :class="pcAvailable ? 'blue-gradient' : 'red-gradient'"
            />
          </div>
