  ...
  <div>
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex space-x-2">
        ...
        <button class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 flex items-center transition-colors"
      ...
      <div class="p-4 border-b border-gray-200 flex items-center justify-between">
        <div class="flex space-x-4">
          <select v-model="selectedAction"
            ...
            <option value="seat_assignment">Seat Assignment</option>
            <option value="seat_unassignment">Seat Unassignment</option>
            <option value="Schedule_added">Schedule Added</option>
